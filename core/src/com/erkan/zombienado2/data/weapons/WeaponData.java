...
public class WeaponData {
    ...
    public static WeaponData PISTOL = new WeaponData("9mm pistol",4, 2, 3, 3, 1,10, 1, .70f, HeldType.ONE_HANDED, "weapons/1h_pistol.png", "audio/pistol.mp3", "audio/pistol_reload.mp3");
    public static WeaponData UZI = new WeaponData("UZI",3, 22, 2, 20, 1,30, 2, .70f, HeldType.ONE_HANDED, "weapons/1h_smg.png", "audio/smg.mp3", "audio/rifle_reload.mp3");
    public static WeaponData AK47 = new WeaponData("Kalashnikov",6, 7, 4, 15,1, 30, 2.8f,1f, HeldType.TWO_HANDED, "weapons/2h_ak47.png", "audio/ar2.mp3", "audio/rifle_reload.mp3");
    public static WeaponData ASSAULT_RIFLE = new WeaponData("Colt M4",5, 12, 2, 10,1, 36, 2.5f,1f, HeldType.TWO_HANDED, "weapons/2h_assault_rifle.png", "audio/ar.mp3", "audio/rifle_reload.mp3");
    public static WeaponData M249 = new WeaponData("FN M249",4, 18, 2, 17,1, 200, 4f,1f, HeldType.TWO_HANDED, "weapons/2h_machinegun.png", "audio/lmg.mp3", "audio/rifle_reload.mp3");
    ...
    public static WeaponData SHOTGUN_PUMP = new WeaponData("Winchester M12",14, .5f, 3, 12, 6,8, 3f, 1f, HeldType.TWO_HANDED, "weapons/2h_shotgun.png", "audio/shotgun_pump.mp3", "audio/shotgun_reload.mp3");
    public static WeaponData SHOTGUN_AUTO = new WeaponData("Franchi SPAS-15",7, 2.5f, 3, 12, 12,8, 3f, 1f, HeldType.TWO_HANDED, "weapons/2h_autoshotgun.png", "audio/shotgun2.mp3", "audio/shotgun_reload.mp3");
